import { fetchHtmlFile, fetchJsonFile } from "../../js/fetch-files.js";
...
async function generatePageList() {
    const pageListContainer = document.querySelector('#watch-recs');
    ...
    const template = await fetchHtmlFile("../templates/recommended-video.html");
